							...
							<div class="col-md-3 border-right">
								...
								<ul class="list-group list-group-flush list-group-custom" role="tablist">
									<li class="list-group-item list-group-item-action display-flex" data-toggle="list" role="tab">
										<a href="<?php echo site_url('drawing_management/drawing_management_client/share_to_me'); ?>" class="w100 display-flex">
									...
									<li class="list-group-item list-group-item-action display-flex" data-toggle="list" role="tab">
										<a href="<?php echo site_url('drawing_management/drawing_management_client/my_approval'); ?>" class="w100 display-flex">
											...
											<table class="table table-items scroll-responsive no-mtop">
												...
												<tbody>
													...
													foreach ($child_items as $key => $value) { 
														...
														$a1 = '<a href="'.site_url('drawing_management/drawing_management_client?id='.$value['id']).'" >';
														$a2 = '</a>';
														?>
														<tr>
															<td>
																	...
																	<ul class="dropdown-menu" aria-labelledby="dropdown_menu_<?php echo drawing_htmldecode($value['id']); ?>">
																		...
																		<?php }
																			...
																			if(!drawing_check_file_locked($value['id'])){ ?>
																				<li class="no-padding">
																					<a href="<?php echo site_url('drawing_management/drawing_management_client?id='.$value['id'].'&edit=1') ?>" data-name="<?php echo drawing_htmldecode($value['name']); ?>"><?php echo _l('dmg_edit_metadata') ?></a>											
																				</li>
																			<?php } 
																		}
																		?>
