<?php if(isset($item) && !drawing_check_share_permission($item->id, 'upload_only', 'customer')){ 
	?>
	<div class="row">
		<div class="col-md-8">
			...
			<table class="table">
				...
				<?php if(!drawing_check_share_permission($item->id, 'preview', 'customer')){ 
					$data_file_selected = [];
		...
		<div class="col-md-4">
			...
			<?php if(drawing_check_share_permission($item->id, 'editor', 'customer')){ ?>
	...
	<div class="panel-default no-border">
		<div class="panel-body no-border">
			...
			<hr>
			<?php 
			if(drawing_check_share_permission($item->id, 'viewer', 'customer') || drawing_check_share_permission($item->id, 'editor', 'customer')){ ?>
			...
			<?php if(!(strpos($item->name, '.docx') === false) || !(strpos($item->name, '.doc') === false)){ ?>
				<?php if(drawing_check_share_permission($item->id, 'viewer', 'customer') || drawing_check_share_permission($item->id, 'editor', 'customer')){ ?>
					<a href="<?php echo site_url('drawing_management/drawing_management_client/preview?id='.$item->id) ?>" target="_blank" class="btn btn-default w100 mtop5 mbot5">
